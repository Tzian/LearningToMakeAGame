...
namespace Cheky.Editor
{
    public class AddressableCheckStarter
    {
        ...
        static AddressableAssetSettings GetAddressableSettings()
        {
            ...
            setting = (AddressableAssetSettings) AssetDatabase.LoadAssetAtPath(settingsPath[0] + "/" + settingsName + ".asset",
        ...
        static AddressableAssetGroup FindOrCreateAddressableGroup(string addressableGroupName)
        {
            ...
            return (AddressableAssetGroup) AssetDatabase.LoadAssetAtPath(addressableGroupsPath[0] + "/" + addressableGroupName + ".asset",
